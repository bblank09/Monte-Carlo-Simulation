...
export const mockFunds: FundSummary[] = [
  {
    ...
    display_name: "K-EQUITY",
    search_term: "ตราสารทุน",
    amc_name_th: "บริษัทหลักทรัพย์จัดการกองทุน กสิกรไทย จำกัด",
    amc_name_en: "KASIKORN ASSET MANAGEMENT COMPANY LIMITED",
    policy_desc: "ตราสารทุน",
    nav_start: "2015-01-05",
    nav_end: "2026-07-31",
    nav_months: 135,
    nav_span_months: 139,
    nav_completeness: 0.9712230216,
    nav_gap_count: 1,
  ...
  {
    proj_id: "M0088_2540",
    unique_id: "C0000000088",
    fund_class_name: "main",
    class_abbr_name: "main",
    display_name: "SCB-EQUITY",
    search_term: "ตราสารทุน",
    amc_name_th: "บริษัทหลักทรัพย์จัดการกองทุน ไทยพาณิชย์ จำกัด",
    amc_name_en: "SCB Asset Management",
    policy_desc: "ตราสารทุน",
    nav_start: "2015-01-05",
    nav_end: "2026-07-31",
    nav_months: 135,
  ...
  {
    proj_id: "M0154_2544",
    unique_id: "C0000000154",
    fund_class_name: "main",
    class_abbr_name: "main",
    display_name: "BBL-FIXED",
    search_term: "ตราสารหนี้",
    amc_name_th: "บริษัทหลักทรัพย์จัดการกองทุน บัวหลวง จำกัด",
    amc_name_en: "BBL Asset Management",
  ...
  {
    proj_id: "M0301_2551",
    unique_id: "C0000000301",
    fund_class_name: "main",
    class_abbr_name: "main",
    display_name: "KFS-FIXED",
    search_term: "ตราสารหนี้",
    amc_name_th: "บริษัทหลักทรัพย์จัดการกองทุน กรุงศรี จำกัด",
    amc_name_en: "Krungsri Asset Management",
    policy_desc: "ตราสารหนี้",
    nav_start: "2015-01-05",
    nav_end: "2026-07-31",
    nav_months: 135,
...
export function mockSimulateResponse(request: SimulateRequest): SimulateResponse {
  ...
  const response: SimulateResponse = {
    run_id: `run_mock_${request.simulation_model}`,
